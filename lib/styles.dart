...
class Stylez {
  ...
  static const TextStyle screenTitle = TextStyle(fontWeight: FontWeight.bold, fontSize: 20);
  ...
  static forContext(BuildContext context, TextStyle style) => style.copyWith(color: Theme.of(context).accentColor);
}
